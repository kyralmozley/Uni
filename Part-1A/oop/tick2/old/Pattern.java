...
public class Pattern {
    ...
    //boolean[][] mWorld = new boolean[mHeight][mWidth];
    ...
    public void initialise(World world) {
       ...
       /*
       changing from array to World
       Hint: you need to remove any code that
       assumes world is an array (e.g. world[x][y]=true; and replace it
       with calls to the more general setCell()
       (e.g. (world.setCell(x,y,true);)). */
