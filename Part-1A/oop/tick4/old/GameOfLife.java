...
public class GameOfLife {
    ...
    private World copyWorld(boolean useCloning) {
       // TODO later
       //return a reference to a copy of the mWorld object created using the copy constructor you have written when useCloning is false
       if (useCloning == false) {
        ...
        while (!response.equals("q")) {
                ...
                if (response.equals("f")) {
                  ...
                  Pattern p = null;
                   ...
                   p = mStore.getPatternsNameSorted().get(patternNum);
                   ...
                   try {
                     if (p.getWidth()*p.getHeight()<64) {
                       ...
                       mWorld = new ArrayWorld(p);
           					...
           					throw new IOException("Invalid pattern within the pattern store");
           				}
			            print();
                 }
               }
