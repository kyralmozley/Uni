...
import uk.ac.cam.cl.km687.exercises.Exercise5;
...
public class RunTask5OnLexicon {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IExercise1 implementation3 = new Exercise1();
        Map<Path, Sentiment> simpleClass = implementation3.simpleClassifier(testSet.keySet(), lexiconFile);
        double calculatedAccuracy = implementation3.calculateAccuracy(testSet, simpleClass);

        Map<Path, Sentiment> newsimpleClass = implementation3.simpleClassifier(newTestSet.keySet(), lexiconFile);
        double newcalculatedAccuracy = implementation3.calculateAccuracy(newTestSet, newsimpleClass);
        System.out.println("Improved Classifier accuracy:");
        System.out.println(calculatedAccuracy);
        System.out.println();
        System.out.println("Improved 2016 Classifier accuracy:");
        System.out.println(newcalculatedAccuracy);
        System.out.println();

        Map<Path, Sentiment> isimpleClass = implementation3.improvedClassifier(testSet.keySet(), lexiconFile);
        double icalculatedAccuracy = implementation3.calculateAccuracy(testSet, isimpleClass);

        Map<Path, Sentiment> inewsimpleClass = implementation3.improvedClassifier(newTestSet.keySet(), lexiconFile);
        double inewcalculatedAccuracy = implementation3.calculateAccuracy(newTestSet, inewsimpleClass);
        System.out.println("Improved Classifier accuracy:");
        System.out.println(icalculatedAccuracy);
        System.out.println();
        System.out.println("Improved 2016 Classifier accuracy:");
        System.out.println(inewcalculatedAccuracy);
        System.out.println();
